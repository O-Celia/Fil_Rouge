            ...
            steps {
                script {
                    dir('terraform/helm') {
                        ...
                        sh "kubectl apply -f configmapDashboard.yml"
                ...
                script {
                    dir('terraform/helm') {
                        ...
                        sh('''
                            ...
                            helm repo update
                            helm upgrade --install prometheus prometheus-community/kube-prometheus-stack -f prom-graf-values.yaml -f dashboard-values.yaml
                        ''')
